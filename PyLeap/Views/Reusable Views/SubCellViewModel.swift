            ...
            for case let fileURL as URL in enumerator {
                ...
                do {
                    ...
                    let filteredFiles = files.filter {
                        $0.path.contains("CircuitPython 7.x")
                    }
                    ...
                    print("Filtered Array: \(filteredFiles)")
                    numOfFiles = filteredFiles.count
...
//            }
    ...
    @Published var texttest = "Testing"
